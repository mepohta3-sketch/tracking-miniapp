        ...
        <div style={cardStyle}>
          ...
          <div style={softCardStyle}>
            ...
            >
              ...
              <div>
                Если статус долго не меняется, не переживай — небольшие паузы между этапами логистики бывают нормой.
              </div>

              <div>
                Если появились вопросы по срокам, доставке или самому товару — сразу напиши в службу заботы в Telegram.
              </div>

              <div>
                Чтобы получить ответ быстрее, укажи номер заказа и коротко опиши свой вопрос.
              </div>
            </div>
          </div>
        </div>
